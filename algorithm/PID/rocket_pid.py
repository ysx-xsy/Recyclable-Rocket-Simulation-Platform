...
class Rocket(object):
    ...
    def __init__(self, max_steps, task='landing', rocket_type='falcon',
        ...
        self.env_params = {'rho': self.m_simu / (125/(self.g/2.0))**0.5, 'q': 0, 'fin_area': self.fin_area, 'H': self.H, 'W': self.H/10, 'I': self.I, 'count': 0, 'm': self.m_simu, 'g': self.g, 'wind_v': self.wind_v}
    ...
    def step(self, action=None):
        ...
        f, vphi, vdelta_L, vdelta_R = self.pid_controller.get_action(self.state, self.env_params, self.wind_strength)
